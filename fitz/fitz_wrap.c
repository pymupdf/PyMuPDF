...
SWIGINTERN PyObject *fz_document_s_embeddedFileSetInfo(struct fz_document_s *self,PyObject *id,char *filename,char *desc){
            pdf_document *pdf = pdf_document_from_fz_document(gctx, self);
            fz_try(gctx)
            {
                assert_PDF(pdf);
...
SWIGINTERN int fz_document_s_embeddedFileAdd(struct fz_document_s *self,PyObject *buffer,char *name,char *filename,char *desc){
            pdf_document *pdf = pdf_document_from_fz_document(gctx, self);
...
SWIGINTERN PyObject *fz_page_s_insertImage(struct fz_page_s *self,struct fz_rect_s *rect,char const *filename,struct fz_pixmap_s *pixmap,PyObject *stream,int overlay){
            pdf_page *page = pdf_page_from_fz_page(gctx, self);
            pdf_document *pdf;
            fz_pixmap *pm = NULL;
            fz_pixmap *pix = NULL;
...
SWIGINTERN PyObject *fz_annot_s_fileUpd(struct fz_annot_s *self,PyObject *buffer,char *filename){
            pdf_annot *annot = pdf_annot_from_fz_annot(gctx, self);
...
SWIGINTERN PyObject *_wrap_Document_embeddedFileSetInfo(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (obj2) {
    res3 = SWIG_AsCharPtrAndSize(obj2, &buf3, NULL, &alloc3);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "Document_embeddedFileSetInfo" "', argument " "3"" of type '" "char *""'");
    }
    arg3 = (char *)(buf3);
  }
  if (obj3) {
    ...
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "Document_embeddedFileSetInfo" "', argument " "4"" of type '" "char *""'");
    }
    arg4 = (char *)(buf4);
  }
  {
    result = (PyObject *)fz_document_s_embeddedFileSetInfo(arg1,arg2,arg3,arg4);
    if(!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_Page_insertImage(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO|OOOO:Page_insertImage",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_fz_page_s, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    result = (PyObject *)fz_page_s_insertImage(arg1,arg2,(char const *)arg3,arg4,arg5,arg6);
    if(!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
SWIGINTERN PyObject *_wrap_Annot_fileUpd(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    result = (PyObject *)fz_annot_s_fileUpd(arg1,arg2,arg3);
    if(!result)
    {
      PyErr_SetString(PyExc_RuntimeError, fz_caught_message(gctx));
      return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Page_addLineAnnot", _wrap_Page_addLineAnnot, METH_VARARGS, (char *)"Page_addLineAnnot(self, p1, p2) -> Annot"},
	 { (char *)"Page_addTextAnnot", _wrap_Page_addTextAnnot, METH_VARARGS, (char *)"Page_addTextAnnot(self, point, text) -> Annot"},
	 { (char *)"Page_addStrikeoutAnnot", _wrap_Page_addStrikeoutAnnot, METH_VARARGS, (char *)"Page_addStrikeoutAnnot(self, rect) -> Annot"},
	 { (char *)"Page_addUnderlineAnnot", _wrap_Page_addUnderlineAnnot, METH_VARARGS, (char *)"Page_addUnderlineAnnot(self, rect) -> Annot"},
	 { (char *)"Page_addHighlightAnnot", _wrap_Page_addHighlightAnnot, METH_VARARGS, (char *)"Page_addHighlightAnnot(self, rect) -> Annot"},
	 { (char *)"Page_addRectAnnot", _wrap_Page_addRectAnnot, METH_VARARGS, (char *)"Page_addRectAnnot(self, rect) -> Annot"},
	 { (char *)"Page_addCircleAnnot", _wrap_Page_addCircleAnnot, METH_VARARGS, (char *)"Page_addCircleAnnot(self, rect) -> Annot"},
	 { (char *)"Page_addPolylineAnnot", _wrap_Page_addPolylineAnnot, METH_VARARGS, (char *)"Page_addPolylineAnnot(self, points) -> Annot"},
	 { (char *)"Page_addPolygonAnnot", _wrap_Page_addPolygonAnnot, METH_VARARGS, (char *)"Page_addPolygonAnnot(self, points) -> Annot"},
	 { (char *)"Page_addFreetextAnnot", _wrap_Page_addFreetextAnnot, METH_VARARGS, (char *)"Page_addFreetextAnnot(self, pos, text, fontsize=11, color=None) -> Annot"},
