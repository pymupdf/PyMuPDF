...
for spage in src:                           # for each page in input
    xref = 0                                # init xref number
    r = spage.rect                          # input page rectangle
    d = fitz.Rect(spage.CropBoxPosition,    # delta if MediaBox != CropBox
                  spage.CropBoxPosition)
    # example: cut input page in 2 x 2 parts
