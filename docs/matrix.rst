...
Examples
-------------
Here are examples that illustrate some of the achievable effects. All pictures show some text, inserted subject to the operation of some matrix, relative to a fixed reference point (red dot).
