...
extensions = ['sphinx_copybutton','notfound.extension','sphinxcontrib.googleanalytics', 'sphinx.ext.autodoc']
...
pymupdf_root = os.path.abspath(f'{__file__}/../../')
import subprocess
...
_run(f'pip install pymupdf')

import pymupdf

pymupdf_root2 = os.path.abspath(f'{pymupdf.__file__}/..')
_run(f'sphinx-apidoc -f -o {pymupdf_root}/docs/ {pymupdf_root2}')
