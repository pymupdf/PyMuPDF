...
latex_documents = [
  ('index', 'PyMuPDF.tex', u'PyMuPDF 1.10 Documentation',
   u'Jorj X. McKie', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "PyMuPDF.png"
...
man_pages = [
    ('index', 'PyMuPDF', u'PyMuPDF 1.10 Documentation',
     [u'Jorj X. McKie'], 1)
]
